...
### 2.7.1 Distribution Between All Numerical Variables vs Customers Status
...
churn_model1 <- dummy_cols(churn_model, select_columns = "Geography") %>%
...
-   the top 6 predictors that random forest selected are the same as the previous models we have seen so far
